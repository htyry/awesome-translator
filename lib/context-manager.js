...
export class ContextManager {
  ...
  async addSentence(tabId, intent, sourceText) {
    ...
    // Read configurable interval from storage (default 10)
    const result = await chrome.storage.local.get('keywordUpdateInterval');
    const interval = result.keywordUpdateInterval || 10;
